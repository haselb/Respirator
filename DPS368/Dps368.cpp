...
//using namespace dps;
using namespace dps368;


int16_t Dps368::getContResults(float *tempBuffer,
							   uint8_t &tempCount,
							   float *prsBuffer,
							   uint8_t &prsCount)
{
...
int16_t Dps368::setInterruptSources(uint8_t intr_source, uint8_t polarity)
{
...
int16_t Dps368::readcoeffs(void)
{
...
int16_t Dps368::configTemp(uint8_t tempMr, uint8_t tempOsr)
{
...
int16_t Dps368::configPressure(uint8_t prsMr, uint8_t prsOsr)
{
...
float Dps368::calcTemp(int32_t raw)
{
	float temp = raw;
...
float Dps368::calcPressure(int32_t raw)
{
	float prs = raw;
